...
const ProductReview = ({ productData }) => {
  ...
  const onSubmit = (data) => {
    ...
    const feedbackInfo = {
      ...data, photoURL, rating, product_id, product_name
    }
  ...
  return (
    <div className="w-full mt-10 border-2 rounded-3xl p-10">
      ...
      <h4 className="text-2xl uppercase mt-6">Be the first to review "{productData.product_name}"</h4>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <p className="text-xs -mt-2 mb-4">Save my name, email, and website in this browser for the next time I comment.</p>
        <input
          type="submit"
          value="Submit"
