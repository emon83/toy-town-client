        ...
        <div>
           <div className="lg:flex gap-10 my-container lg:w-[1340px] mt-10">
            ...
            <div className="lg:w-1/2">
                ...
                <p className="text-gray-600 font-light mt-6 mb-4">{description}</p>
                ...
                <p className="my-4">Categories: <span className="badge badge-md bg-gray-100 border-none text-gray-600">{subCategory}</span></p>
