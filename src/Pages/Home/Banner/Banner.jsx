...
const Banner = () => {
    return (
        <div className='relative'>
            ...
            <h1 className='text-3xl sm:text-5xl md:text-7xl font-bold primary-font text-center'>Toytown - Kids Toys Store</h1>
            ...
            <div className='text-center'>
                <button className='btn uppercase btn-color border-none rounded-3xl text-xs sm:text-sm md:text-base btn-sm sm:btn-md px-6'>Learn More</button>
            </div>
        </div>
        </div>
    );
